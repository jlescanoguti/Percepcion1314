...
MODEL_PATH = "modelo_reconocimiento.pth"
CLASES_PATH = "clases_modelo.json"
...
# === Transformaciones y data augmentation agresivo ===
...
if not verificar_dataset():
    ...
    print("💡 Registra al menos un alumno con imagen antes de entrenar")
    clases = []
